import { parseCondition, parseEffects, parseItem, parseQuestion, parseRule } from "./parser";
...
describe('Parser', () => {
    ...
    describe('parseEffects', () => {
        it('should parse effects', () => {
            const effects = parseEffects("Is it sunny? $sunny(true), [utility] Scrubber, [utility] Clothesline");
    ...
    describe('parseRule', () => {
        it('should parse a rule', () => {
            const rule = parseRule("a AND b :- Is it sunny? $sunny(true), [utility] Scrubber, [utility] Clothesline");
