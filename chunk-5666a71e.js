import{$ as e,da as n,qc as t}from"./chunk-8005388a.js";var o=`<h1 id="wiemanregelndefiniert">Wie man Regeln definiert</h1>
...
Es kann verwirrend werden.</p>`;var i=`<h1 id="howtodefinerules">How to define rules</h1>
...
It can get confusing.</p>`;var a=new e("RULES_DOCUMENTATION");function d(s){return s.startsWith("de")?o:i}function p(){return n([{provide:a,useFactory:d,deps:[t]}])}var g={rules:a};export{p as a,g as b};
/**i18n:dfa52c7a7e16db02da72dd7a9f372f1a5e871fd2da22f4ab798a7539933ec388*/
