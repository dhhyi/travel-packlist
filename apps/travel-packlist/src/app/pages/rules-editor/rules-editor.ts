...
import { IconSwap } from '@travel-packlist/icons';
...
import { EditorRule } from './editor-rule/editor-rule';
import { EditorTitle } from './editor-title/editor-title';
import { Toolbar } from './toolbar/toolbar';

@Component({
  selector: 'app-rules-editor',
  imports: [EditorRule, Toolbar, IconSwap, EditorTitle],
